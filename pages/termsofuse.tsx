        ...
        <>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              Platform, you must be at least 18 years old, have the capacity to
              enter into legally binding contracts and reside in a country in
              which the relevant services and products are available or you must
              be at least 14 years old and you perform the transactions by means
              granted by your legal representative for use on the Platform or
              for free use. Your access to certain Supported Games, services or
              products may be limited based on the age rating of the Supported
              Game as applicable in your country.
            </p>
            <p className="privacy__default-text">
              You can access the Platform through commonly used web browsers on
              your personal computers, laptops, or mobile devices, including but
              not limited to Google Chrome, Mozilla Firefox, Apple Safari, and
              Microsoft Edge. You must ensure that the browser is compatible
              with the Platform's technical requirements and is updated to the
              latest version to ensure optimal performance and security. The
              Company does not guarantee that the Platform will be accessible or
              function optimally on all browsers or devices.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              By submitting, posting, or displaying any text, images, videos, or
              other materials (collectively, "User Content") on or through the
              Platform, you grant us a perpetual, non-exclusive, worldwide,
              royalty-free, sublicensable, and transferable license to use,
              reproduce, modify, adapt, publish, distribute, publicly display,
              and perform the User Content in connection with the operation of
              the Platform and the Company's (and its successors' and
              affiliates') business, including for promoting and redistributing
            ...
            <p className="privacy__default-text">
              ...
              may use and display information including your in-game name, rank,
              profile picture, stream-captured video and other data that we deem
              relevant to improve the available content, advertise your products
              and services, and improve interactions within the Platform.
            </p>
            <p className="privacy__default-text">
              You can delete individual content that you share, post and upload
              at any time. In addition, all content posted to your personal
              account will be deleted if you delete your account. To delete your
              account, please follow the procedure described in the Privacy
              Policy.{" "}
            </p>
            <p className="privacy__default-text">
              You grant us the right to utilize any ideas or concepts contained
              within User Content for any purpose, including but not limited to,
              product and service development, manufacturing, marketing, or
              generating informational articles, without providing any
              compensation to you. To the maximum extent permitted by law, you
              waive any moral rights you may possess in your submitted User
              Content.
            </p>
            <p className="privacy__default-text">
              You agree not to submit, post, or display any User Content on the
              Platform that infringes upon or violates the copyright, trademark,
              or other intellectual property rights of any third party. By
              submitting User Content, you represent and warrant that you have
              the necessary rights, licenses, consents, and permissions to
              publish User Content and to grant the consents specified in these
              terms of use.
            </p>
            <p className="privacy__default-text">
              ...
              format, sizing, and any other specifications of User Content as we
              see fit.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              making any monetary transactions, you will need to register for an
              account by providing your identification information and accepting
              the terms of these Terms. By using the Platform, you agree and
              represent that you will use the Platform only for yourself, and
              not on behalf of any third party. You are fully responsible for
              all activity that occurs under your account. The Company may, in
              our sole discretion, refuse to open an account for you, or limit
              the number of accounts that you may hold or suspend or terminate
              any account.
            </p>
            <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              ...
              address, telephone number, email address, date of birth, taxpayer
              identification number, government identification number, billing
              type, source of funds, government issued documents, marital
              status, title, gender, residential address, nationality and other
              requested details. The nature and extent of the information you
              are required to provide may differ, for example, based on the
              services provided to you under this Agreement and/or the means of
              payment you use. In providing us with this or any other
              information that may be required, you confirm that the information
              is accurate and correct and you agree to keep us updated if any of
              the information you provide changes. We will treat this
              information in accordance with the data protection provisions of
              this Agreement.
            </p>
            <p className="privacy__default-text">
              ...
              protect you and/or us against fraud or other financial crime, and
              to take action we reasonably deem necessary based on the results
              of such inquiries. When we carry out these enquiries, you
              ...
              amount of time after completion of a transaction before permitting
              you to use further Company services and/or before permitting you
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              and any applicable fees or charges, shall be displayed separately
              on the Platform ("Competition Terms"). Users organizing and
              participating in such competitions are responsible for
              understanding and adhering to the Competition Terms.
            </p>
            <p className="privacy__default-text">
              ...
              Company reserves the right to modify or remove any user-organized
              competition that violates these Terms of Use, the Platform's rules
              and guidelines, or any applicable laws or regulations.
            </p>
          </div>

          <div className="privacy__text-block">
            <h2 className="privacy__min-title">
              6. Placing Orders, Payment, Relationship between Service Provider
              and Client
            </h2>
            <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              ...
              the order process. The pricing shown and valid at the time of the
              order shall apply. Fees may be charged for our services and for
              the Service Providers, which will be clearly displayed to users
              prior to completing a purchase. By placing an order, you agree to
              pay all applicable fees and taxes. The full amount will be charged
            ...
            <p className="privacy__default-text">
              ...
              (including Xsolla, Google Pay, Apple Pay) for payments (EUR). The
              list of available payment methods and supported payment gateways
            ...
            <p className="privacy__default-text">
              ...
              that of an independent contractor. The Platform is not a party to
              this agreement and assumes no responsibility for the performance
              of either party under the agreement.{" "}
            </p>
            <p className="privacy__default-text">
              Service providers are independent contractors and not employees,
              partners, or agents of the Company. We do not endorse, guarantee,
              or assume responsibility for any service provided by a Service
              Provider.
            </p>
            <p className="privacy__default-text">
              We may be obligated to report transactions made by you as a
              Service Provider through the Platform to applicable local tax
              board or authority. You agree that the information related to the
              transaction and the information from your account may be provided
              to the extent necessary for fulfilment of our obligations to tax
              authorities.
            </p>
          </div>

          <div className="privacy__text-block">
            <h2 className="privacy__min-title">7. Cancellations And Refunds</h2>
            <p className="privacy__default-text">
              Once an order to buy or sell has been made it cannot be cancelled
              or recalled.
            </p>
            <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              ...
              obligation towards you will be absolutely discharged upon delivery
              of the product or service to you or intermediation to the Service
              Provider and you shall have no claim or right against the Company
              upon such delivery.
            </p>
            <p className="privacy__default-text">
          ...
          <div className="privacy__text-block">
            ...
            <ul style={{ marginLeft: "1rem" }}>
              <li>
                <p className="privacy__default-text">
                  there is a reason to suspect that you are acting in breach of
                  this Agreement or applicable legislation;
                </p>
              </li>
              <li>
                <p className="privacy__default-text">
                  your User Content is identified to be in breach of third-party
            ...
            <p className="privacy__default-text">
              In the event of any termination, whether by you or us, these Terms
              of Service will continue in full force and effect, including our
              right to use User Content. In the case any of the above become
              applicable, the Company shall make reasonable efforts to inform
              you about the withholding or suspension.
            </p>
            <p className="privacy__default-text">
              The Company shall not be liable for any losses you may suffer as a
              result of any reasonable action taken in accordance with this
              clause.
            </p>
            <p className="privacy__default-text">
              ...
              account and the services and/or issue you with new account details
              and reserves the right to ask you to repeat the account opening
              procedure in part or in full as outlined in this Agreement and to
              resolve any open issues with your account before a restriction is
              removed.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              The Platform uses third-party services to process any payments and
              transactions between you, the Company and other users. All of your
              interactions with third parties and the services they provide are
              regulated by different terms, conditions and policies, and to
              which you expressly and independently agree whenever you execute
              third party agreements and conduct with/through them.
            </p>
            <p className="privacy__default-text">
              All fees payable under this Agreement, including taxes are
              displayed during the operation flow and shall be paid in currency
            ...
            <p className="privacy__default-text">
              ...
              or payment provider. These can include administration fees levied
              by the card acquirer and card schemes.
            </p>
            <p className="privacy__default-text">
              In the case of intermediation between the customer and a Service
              Provider, the Company acts as a commercial agent with a
              contractual right to negotiate the sale or purchase of services or
              to enter into contracts for the sale or purchase of services on
              behalf of only the Service Provider.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              securely on our account in a payment service provider before final
              purchase of the respective services. You must ensure that you have
              sufficient funds in the wallet to initiate transactions and obtain
              services within the platform. All payments are subject to
              applicable fees and conversion rates, as determined at the time of
              transaction. You will not be entitled to additional rewards,
              bonuses or payments for the funds held in the wallet.
            </p>
            <p className="privacy__default-text">
              ...
              reserves the right to suspend, limit, or terminate your access to
              the wallet feature in the event of any violations of these terms
              of use or any applicable laws and regulations. In case your
              account is deleted or in other cases upon clicking on the
              “withdraw” button, the amounts held in the wallet will be returned
              to the original account from which the transaction was made,
              unless there is a legal obligation restricting our right to make
              the transaction. You shall be solely responsible for indicating
              the account to which repayments will be made.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              procedure prescribed by the terms of the Privacy Policy available
              at the Platform.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              This clause sets out the entire financial liability for any acts,
              representations, misrepresentations, omissions or tortious acts of
              the Company, its employees, agents and subcontractors with respect
              to and arising from this Agreement or the use of the Platform
            </p>
            <p className="privacy__default-text">
              All warranties, representations, conditions and all other terms of
              any kind whatsoever implied by law are excluded from this
              Agreement to the fullest extent permitted by applicable law.
            </p>
            <p className="privacy__default-text">
              The Company shall not be held liable for any disputes, claims, or
              issues that may arise from user-organized competitions, including
              but not limited to, the enforcement of the Competition Terms, the
              distribution of prize pools, or the conduct of participants. Users
              organizing and participating in competitions do so at their own
              risk and agree to indemnify and hold harmless the Company from any
              claims, damages, or losses resulting from their involvement in
              user-organized competitions.
            </p>
            <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              ...
              ore benefit needed, desired, or required by law from the Company.
            </p>
            <p className="privacy__default-text">
              You agree to promptly cooperate with us and provide the documents
              necessary, as may be reasonably requested, for purposes tax audit,
              including but not limited to records showing you is engaging in an
              independent business operated through the Platform. You
              acknowledge that you must comply with your obligations under
            ...
            <p className="privacy__default-text">
              ...
              damages, legal action whatsoever related to any service or product
              available on the Platform, any technology used by the Company or
              related parties. You accept the inherent security risks of
              providing information and dealing online over the internet and
              agree that we have no liability or responsibility for any breach
              of security unless it is due to our gross negligence. If
              applicable law does not allow all or any part of the above
          ...
          <div className="privacy__text-block">
            ...
            <ul style={{ marginLeft: "1rem" }}>
              ...
              <li>
                <p className="privacy__default-text">
                  ...
                  advice on the suitability and appropriateness of Platform for
                  your needs;
                </p>
              </li>
              <li>
                <p className="privacy__default-text">
                  you will not violate any applicable laws by entering into this
                  Agreement or receiving the services provided under it;
                </p>
              </li>
              <li>
                <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              Company makes no representation or warranty that the services are
              applicable or appropriate for use by customers in all
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              ...
              fraud, or charges more than you expected, and not receiving the
              good or service, you are advised to contact us help@cyberyal.com
            </p>
            <p className="privacy__default-text">
              More information about dispute and consumer protection provisions
              are described in clause 16 of the Agreement.
            </p>
          </div>
          ...
          <div className="privacy__text-block">
            ...
            <p className="privacy__default-text">
              The logos and trademarks displayed on the Platform are registered
              marks and intellectual property rights of the Company. You may not
              copy, imitate or use them without our prior written consent or any
              third party's copyright, trade secret, patent or other
            ...
            <p className="privacy__default-text">
              ...
              Agreement immediately and free of charge with effect at any time.
            </p>
            <p className="privacy__default-text">
              ...
              revised Agreement becomes effective. Although we will endeavour to
              provide you with advance notice where possible, where lawful we
              may indicate that the revised Agreement shall be effective
            ...
            <p className="privacy__default-text">
              ...
              connection with the Platform. Such information may only be used to
              the extent reasonably necessary to carry out a transaction and
              other functions reasonably incidental thereto such as support,
              reconciliation and accounting unless you receive the other
              customer’s express consent to do so. You may not send unsolicited
              communications to another customer through the Platform, unless
              expressly allowed by the other customer.
            </p>
            <p className="privacy__default-text">
              ...
              versions of this Agreement) between you and the Company.
            </p>
            <p className="privacy__default-text">
              Section headings in this Agreement are for convenience only and
              shall not govern the meaning or interpretation of any provision of
              this Agreement.
            </p>
            <p className="privacy__default-text">
            ...
            <p className="privacy__default-text">
              ...
              Agreement. If we do choose not to enforce our rights at any time,
              it shall not be seen as renouncement of such right.
            </p>
            <p className="privacy__default-text">
