            ...
            <main className="wrapper">
                ...
                <div className="privacy__wrapper">
                    ...
                    <div className="privacy__text-block">
                        ...
                        <p className="privacy__default-text">
                            You can delete individual content that you share, post and upload at any time. In addition, all content posted to your personal account will be deleted if you delete your account. To delete your account, please follow the procedure described in the Privacy Policy.                        </p>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">4. Customer Registration Process</h2>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">5. User-Organized Competitions</h2>
                        <p className="privacy__default-text">
                            The Platform allows users to organize and participate in competitions involving Supported Games. Users may create competitions that involve two or more participants, with the option of establishing prize pools for the winners.                        </p>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">6. Placing Orders, Payment, Relationship between Service Provider and Client</h2>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">8. Suspension, termination and cancellation</h2>
                        <p className="privacy__default-text">
                        ...
                        <ul style={{ marginLeft: '1rem' }}>
                            <li><p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">10. Wallet Use and Prepayment for Services</h2>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        <h2 className="privacy__min-title">13. Warranties and Representations</h2>
                        <p className="privacy__default-text">
                    ...
                    <div className="privacy__text-block">
                        ...
                        <p className="privacy__default-text">
                            In order to resolve disputes, you, as a private customer, may address the Consumer Disputes Committee. The Consumer Disputes Committee is authorized to resolve disputes arising from contracts entered into between purchasers and sellers that the parties have failed to resolve by way of negotiations. Further information on the resolution of complaints is available at <a href="https://ttja.ee/en/consumer-disputes-committee">https://ttja.ee/en/consumer-disputes-committee</a>.
                        </p>
                        <p className="privacy__default-text">
