        ...
        <div className="content"></div>
          <div className="privacy__wrapper">
            ...
            <p className="privacy__default-text">
              ...
              interact with the Website and the Service. If we decide to change
              our privacy policy, we will post those changes on this page
            </p>
            ...
            <div className="privacy__text-block">
              ...
              <ul className="privacy__list">
                <li className="privacy__item">
                  <p className="privacy__default-text">
                    Service (referred to as either "Website", "We", "Us" or
                    "Our" in this Cookies Policy) represents the “Cyberyal”
                    website accessible from http://cyberyal.com
                  </p>
                </li>
                <li className="privacy__item">
                  <p className="privacy__default-text">
            ...
            <div className="privacy__text-block">
              ...
              <p className="privacy__default-text">
                ...
                our offer. This data protection declaration tells you how data
                are collected and the particular purposes for which they are
                used.
                <br />
                <br />
                ...
                <br />
                <br />
                By submitting your information we obtain your consent for
                sending you advertising material or the Newsletter. Should you
                no longer wish to receive notifications from the Service, you
                may unsubscribe from our mailing list using the option provided
                at the bottom of our Newsletters.
              </p>
            </div>
            ...
            <div className="privacy__text-block">
              ...
              <p className="privacy__default-text">
                ...
                require. In addition, we may pass personal data on to third
            ...
            <div className="privacy__text-block">
              ...
              <p className="privacy__default-text">
                The Service takes organisational measures to ensure data
                security, in particular to protect your personal data against
                loss, manipulation or unauthorised access. Unfortunately,
                ...
                necessary to provide our contractual services or for the
                duration prescribed by law. We may also store personal data for
                as long as we need such data to enforce claims or defend
                ourselves against claims. To the extent that your data are no
                longer needed for the above purposes, they will be deleted.
              </p>
            </div>
            ...
            <div className="privacy__text-block">
              ...
              <p className="privacy__default-text">
                You may withdraw consent given to us at any time by notifying
                us; such withdrawal will take effect for the future.
              </p>
            </div>
          </div>
        </div>
