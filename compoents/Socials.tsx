...
function Socials() {
    return (
        <div className="socials">
            <h1 className="socials__title">Create and share the Cyberyal on social media platforms</h1>
            <ul className="socials__list">
                ...
                <li className="socials__item socials__item_youtube">
                    ...
                    >   
                        ...
                        <div className="socials__card__info">
                            ...
                            <p className="socials__card-text">Follow our channel on YouTube</p>
                        </div>
                    </a>
                </li>
                <li className="socials__item socials__item_facebook">
                    ...
                    >   
                        ...
                        <div className="socials__card__info">
                            ...
                            <p className="socials__card-text">You can follow us on Facebook</p>
                        </div>
                    </a>
                </li>
                ...
                <li className="socials__item socials__item_share">
                    <a
                        className="socials__card socials__card_discord"
                        href="https://discord.com"
                    >   
