...
import RoadMapMobile from "../../public/roadmap/roadmap-mob-new.png";
  ...
  return (
    <div className="roadmap">
      <header className="roadmap__header">
        <motion.h2 {...animation()} className="roadmap__title">
          Roadmap
        </motion.h2>
      ...
      <motion.div {...animation()} className="roadmap__img">
        ...
        {/* <div
          style={{ width: "100%", margin: "85px 0px" }}
          className="roadmap__img_mob"
        >
          <RoadMapMobile />
        </div> */}
        <Image
