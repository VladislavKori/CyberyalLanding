    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__left">
          ...
          <p className="footer__text-cursive">“All tools for boost your gaming skills”</p>
        ...
        <div className="footer__menu">
          ...
          <div className="footer__block">
            <div className="footer__field">
              ...
              <a href={`tel:${commonInfo.phone}`} className="footer__text_white">{commonInfo.phone}</a>
            </div>
            <div className="footer__field">
              <div className="footer__field-header">
              ...
              <a href={`mailto:${commonInfo.mail}`} className="footer__text_white">{commonInfo.mail}</a>
            </div>
          </div>
        </div>
      </div>
      <div className="footer__bottom">
        <p className="footer__text_gray">* Our platform's services constitute 3 percent of the tournament prize pool. We provide flexible tournament conditions and are ready to work with you to make your tournament a success</p>
        <hr />
        <p className="footer__text_gray">Cyberyal is an independent entity that is not affiliated or endorsed by Blizzard Entertainment, Bungie, or Respawn Entertainment. The views and opinions expressed by Cyberyal do not reflect those of the aforementioned entities or anyone involved in managing their franchises. All trademarks belonging to the aforementioned entities are the property of their respective owners in the U.S.A and/or other countries. All submitted art content remains the copyright of its original copyright holder. Please note that Cyberyal does not sell in-game items; we only offer services to help players improve their in-game skills and provide gifts of in-game items.</p>
        <div className="footer__rights">
          <p className="footer__text_white">© 2023 All rights reserved CYBERYAL LTD 25 Martiou, 27 D. Michael Tower, flat/office 105A, Egkomi, 2408 Nicosia, Amsterdam Reg.No. ΗΕ 416048</p>
